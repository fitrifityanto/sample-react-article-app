    ...
    const listArticle = articles.map (article => 
        <tr key={article.id}>
            ...
            <td className='px-2 py-1 border border-blue-300'>
                                                <img src={article.image_url} />  </td>
            <td className='px-2 py-1 border border-blue-300 text-center'> 
                                            {article.highlight == true ? 'ON' : 'OFF'}
            </td>
            <td className='px-2 py-1 border border-blue-300'>
                                <button className='rounded bg-yellow-500 text-white px-2 py-1 mr-4'>Update</button>
                                <button className='rounded bg-red-500 text-white px-2 py-1'>Delete</button>
            </td>
        </tr>
    )
  return (
